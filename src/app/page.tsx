          ...
          <div className="col-span-2 px-6 lg:px-0 lg:pt-4">
            <div className="relative mx-auto text-center lg:text-left flex flex-col items-center lg:items-start">
              <div className="absolute w-28 left-0 -top-20 hidden lg:block">
                ...
                <img src="/snake-1.png" alt="cobra" className="w-full"/>
              </div>
              <h1 className="relative w-fit tracking-tight text-balance mt-16 font-bold !leading-tight text-gray-900 tet-5xl md:text-6xl lg:text-7xl">Your image on a <span className="bg-green-600 px-2 text-white">Custom</span>Phone Case</h1>
              <p className="mt-8 text-lg lg:pr-10 max-w-prose text-center lg:text-left text-balance md:text-wrap">capture your favorite memories with your own, <span className="font-semibold">one-of-one</span>phone case. CaseCobra ot only protects your phone, but your memories as well</p>

              <ul className="mt-8 space-y-2 font-medium text-left fle fle-col items-center sm:items-start">
                <div className="space-y-2">
                  <li className="flex gap-1.5 items-center text-left">
                    <Check className="h-5 w-5 shrink-zero text-green-600"/>
              ...
              <div className="mt-12 flex flex-col sm:flex-row items-ceter sm:items-start gap-5">
                <div className="flex -space-x-4">
                  ...
                  <img className="inline-block h-10 w-10 object-cover rounded-full ring-2 ring-slate-100" src={"/users/user-5.jpg"} alt="user" />
                </div>
